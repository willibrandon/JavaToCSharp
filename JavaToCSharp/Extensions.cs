...
namespace JavaToCSharp
{
    public static class Extensions
    {
        ...
        public static TSyntax WithJavaComments<TSyntax>(this TSyntax syntax, JavaAst.Node node, string singleLineCommentEnd = null, bool translateJavadocComments = false)
            where TSyntax : SyntaxNode =>
            CommentsHelper.AddCommentsTrivias(syntax, node, singleLineCommentEnd, translateJavadocComments);
    }
}
